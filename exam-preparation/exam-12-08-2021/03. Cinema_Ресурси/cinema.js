...
console.log(cinema.swapSeatsInHall(1.2, 1))
console.log(cinema.swapSeatsInHall({}, 1))
console.log(cinema.swapSeatsInHall(0, 5))
console.log(cinema.swapSeatsInHall(-1, 5))
console.log(cinema.swapSeatsInHall(undefined, 2))
console.log(cinema.swapSeatsInHall('', 3))
